...
export default function EnquiryCheckout (){
  ...
  const handleAddressChange = name => event => {
    ...
    return (
      <Card className={classes.card}>
        ...
        <TextField id="phone" label="Phone Number" className={classes.textField} value={values.checkoutDetails.customer_phone} onChange={handleCustomerChange('customer_phone')} margin="normal"/><br/>
